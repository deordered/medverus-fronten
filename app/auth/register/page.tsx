...
// This page handles the 308 redirect cache issue where browsers redirect /register → /auth/register
// Immediately redirects to the main homepage with integrated registration experience
